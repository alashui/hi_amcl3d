...
{
  // Depth in the tree
  int leaf, depth;//是否为叶子,树的深度

  // Pivot dimension and value//比较的维度以及比较值
  int pivot_dim;
  double pivot_value;

  // The key for this node
  int key[3];//节点的key,这里是粒子的pose(被放大成int)

  // The value for this node
  double value;//节点的value,这里表示该粒子权值
...
{
  // Cell size
  double size[3];// 就是放大pose的比例，默认是0.5 0.5 pi/180*10，除一下就放大了
